  ...
  return (
    <section id="process" className="py-24 bg-gradient-to-br from-navy-800 via-navy-900 to-navy-800 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-64 h-64 bg-navy-500 rounded-full opacity-5"></div>
        <div className="absolute bottom-20 right-20 w-48 h-48 bg-navy-500 rounded-full opacity-5"></div>
